  ...
  <tbody>
    <?php
      ...
      while ($line = pg_fetch_row($result)){
        ...
        echo '<div class="modal fade bd-example-modal-lg m',$i,'" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
        ...
        <div class="modal fade bd-example md',$i,'" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
