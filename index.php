  ...
  <body>
    ...
    <nav class="nav nav-tabs">
      ...
      <div class="nav navbar-nav">
          <a class="nav-item nav-link active" href="index.php">Profesores<span class="sr-only">(current)</span></a>
          <a class="nav-item nav-link" href="career.php">Carrera/Alumno</a>
      </div>
    </nav>
    ...
    <div class="col-lg-6">
      <div class="input-group">
        ...
        <span class="input-group-btn">
          <button class="btn btn-secondary" onclick="loadProfesor()" type="button">Buscar profesor</button>
        </span>
      </div>
    </div>
  </div>
